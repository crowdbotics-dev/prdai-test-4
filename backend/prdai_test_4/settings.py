"""
Django settings for prdai_test_4 project.
...
ROOT_URLCONF = 'prdai_test_4.urls'
...
WSGI_APPLICATION = 'prdai_test_4.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "prdai_test_4 API",
    "DESCRIPTION": "API documentation for prdai_test_4 App",
    "VERSION": "v1",
}
